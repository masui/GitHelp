...
command translation framework with which users can generate a complete
command string.
%
...
A powerful information retrieval mechanism ``{\EH}'' is used in {\GH}.
...
\begin{quote}
  description: \\
  \stt{Find a (Chinese|Korean|Vietnamese) restaurant \\  in (San Francisco|Chicago|New York) \\  on Yelp.com} \\
  command: \\
  \stt{open 'http://www.yelp.com/search?\\  find\_loc=\$2\&find\_desc=\$1'}
\end{quote}
